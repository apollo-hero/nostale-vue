    ...
    const fakers = {
      fakeUsers() {
        ...
        return _.sampleSize(users, 3).map(user => {
          return {
            name: user.name,
            gender: user.gender,
            email: _.toLower(_.replace(user.name, / /g, "") + "")
          };
        });
      },
      fakePhotos() {
        ...
        let news = [
          {
            ...
            super_short_content: _.truncate(
      ...
      fakeFiles() {
        let files = [
          ...
          { file_name: fakers.fakeImages()[0], type: "Image", size: "1.2 MB" },
          ...
          { file_name: fakers.fakeImages()[0], type: "Image", size: "1.4 MB" },
          { file_name: fakers.fakeImages()[0], type: "Image", size: "1 MB" }
        ];
